...
//    }
    ...
    LotteryRecord lRecord, String ids, Query query, HttpServletRequest request)
    {
        ...
        lRecord.setActivitiesid(activitiesid);
	...
	public void getAwardAjax(HttpServletRequest request,
		...
		try {
			if (lotteryRecord.getIsGet() == null
				...
				lotteryRecord.setGetTime(currentDate);
				
				SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:MM:ss");
				String strDate = df.format(currentDate);
				lotteryRecord.setSGetTime(strDate);
				
				lotteryRecord = this.services.updateLotteryRecord(lotteryRecord);
