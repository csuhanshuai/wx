	...
	<div class="container integral integral_record integral_my coupon">
		<header>
			<nav id="nav_1" class="p_10">
				<ul class="box">
					<li><a href="${BasePath}/zj/zjminweb/getConsumption.kq?memberid=${memberid?default("")}&openid=${openid?default("")}&bid=${bid?default("")}" class="<#if !type??>on</#if>">全部</a></li>
					<li><a href="${BasePath}/zj/zjminweb/getConsumption.kq?memberid=${memberid?default("")}&type=1&openid=${openid?default("")}&bid=${bid?default("")}" class="<#if type?? && type=='1'>on</#if>">收入</a></li>
					<li><a href="${BasePath}/zj/zjminweb/getConsumption.kq?memberid=${memberid?default("")}&type=0&openid=${openid?default("")}&bid=${bid?default("")}" class="<#if type?? && type=='0'>on</#if>">支出</a></li>
				</ul>
			</nav>
		</header>
		<div class="body">
		...
		<#if consumptionlist?? && (consumptionlist?size>0) >
	      	<#list consumptionlist as item>
...
<div class="noData" style="background: url(${BasePath}/images/app/zjminweb/12.png) no-repeat center 50px;-webkit-background-size: 140px auto;"></div>
