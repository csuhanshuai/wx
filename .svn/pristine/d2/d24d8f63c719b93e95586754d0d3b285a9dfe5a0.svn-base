...
.toollist_gray li a {color: #fff;}
	...
	.bg{
		...
		top:0;
		left:0;
		background: #000 url(../images/zhufu.jpg) top center no-repeat !important;
...
<div class="container">
    ...
    <div id="bd" class="panel">           
		...
		<div class="paixu">
         ...
         <div class="buttons">
                <a href="${BasePath}/vote/getIndexInformation.kq" class="btn_ex">去首页瞧瞧</a>               
            </div>
</div>
