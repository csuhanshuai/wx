...
<script type="text/javascript" src="${BasePath}/js/app/zjmember/js/dialog_min.js"></script>
		...
		<header>
			<div class="header card">
				...
				<div class="card " data-side="1" onclick="this.classList.toggle(&#39;on&#39;);">					
					...
					<div class="front">
						<div class="fg" style="background-image: url(${BasePath}/images/app/zjmember/card_bg01.jpg);">
							<!--<img id="cardlogoimg" src="${BasePath}/images/app/zjmember/b5186e6a-69d3-4883-8a7e-b0df77ef6d49.png" style="margin-top: 39px;width:185px;height:65px;">-->
