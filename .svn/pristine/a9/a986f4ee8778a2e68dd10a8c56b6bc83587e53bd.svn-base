...
.jscontent{width:80vw; height:100%; top:40vw; padding:5vw; float:left;background:rgba(240,255,255,0.5); border-radius:2.5vw; margin-top:50vw;  }
...
.toollist li a p{margin: 1px 0 1px 0;font-size: 14px;display: block !important;line-height: 18px;text-align: center;}
	...
	<body style="background:url('../images/bj2.jpg') no-repeat;">
	<div class="whole">
  <div class="jscontent">
			<h1 style="font-size:6vw; line-height:10vw;">晒祝福投票活动说明：</h1>
				<p>	1、员工可以晒出收到部门或其他人相应的中秋祝福，或送给其他人中秋祝福的感动瞬间。<br>
					2、图片或者视频中包含自己（他人）以及收到的礼物，可以多张图合成一张。<br>
					3、每个工号只能上传一次参赛作品,参赛者需慎重提交作品,提交后不允许修改。<br>
					4、票数排名前100名可再获得2枚约章,员工投票投中前100名也可获得1枚约章,活动时间结束后,系统自动追加约章。<br>
				</p>	
		</div>
    <div class="kk"></div>
</div>
