...
.sharebg-active { opacity: 1; display:block; }
	...
	<form id="myform"  method="get" target="myiframe"></form>
	<header class="head">
	    <div class="top_0"></div>
    	<div class="top_1">灯谜竟猜排行榜</div>
    	<div class="top_2"></div>
    </header>
    <nav><img style="width:100%; height:30%;" class="banner" src="../images/zhongqiu.jpg"/></nav>
	  <div class="s-index-side">
    <p>您已经没有答题机会，分享可以再次获得答题机会</p>
		<div class="title">
			<h3>游戏竟猜Top3</h3>
		      ...
		      <#list topThree as item>
					<ul class="weekly-list cls">
						<li>
							...
							<span  style="padding-left:0; width:100px; text-align:center; float:left;">${item.empName?default("")}(<span id="jobnumber" class="bk">${item.jobNumber}</span >)</span>
							<span  style="padding-left:0; width:65px; text-align:center; float:left;">&nbsp;&nbsp;${item.score?default("")}</span>
	  ...
	  <div class="buttons">
          ...
          <div class="buttons buttons2">
                <a href="${BasePath}/lanterngame/checkForward.kq?type=1" class="btn_ex btn-danger btn-danger2 btn-block">开始游戏</a>
            </div>   
    ...
    var form = document.getElementById("myform");
    	form.action="${BasePath}/lanterngame/addCanPlayCount.kq";
			form.submit();
	}
...
document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
	window.shareData = {
		"imgUrl": "${BasePath}/images/app/bj.jpg,
		"shareLink": "&share=true#mp.weixin.qq.com",
		"title": "中秋竟猜灯迷",
		"act_type":"竟猜",
		"content": "玩游戏中大奖",
		"openid": Session["empInfo"]["openid"],
		"time":new Date()
	};
	...
	WeixinJSBridge.on('menu:share:timeline', function (argv) {
		WeixinJSBridge.invoke('shareTimeline', {
			...
			"link": window.shareData.shareLink,
			 ...
			 "openid": window.shareData.openid
		}, function (res) {
