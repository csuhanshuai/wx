...
<#if question??>
		<tr>
			<td>
				<div >
	        	标题：${question.title?default("")}
	    		</div>
			</td>
			<td>
				<div >
	        	正确答案：${question.rightTitle?default("")}
	    		</div>
			</td>
		</tr>
		<tr>
			<td>
				<div >
	        	最长答题时间：${question.maxSubmitTime?default("")}
	    		</div>
			</td>
			<td>
				<div>
	        	题目分数：${question.topicScore?default("")}
	    		</div>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<div >
	        	图片：<img style="max-width: 100px;max-height: 100px;" src="${BasePath}/${question.imgUrl?default("")}"/>
	    		</div>
			</td>
		</tr>
		</#if>
