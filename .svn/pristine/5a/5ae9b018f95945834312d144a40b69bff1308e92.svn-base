		      ...
		      <#list topThree as item>
					<ul class="weekly-list cls">
						<li>
							...
							<span style="padding-left:0; width:50px; text-align:center; float:left; float:left; color:#F90; font-weight:bold">${item_index+1}</span>
							...
							<span  style="padding-left:0; width:90px; text-align:right; float:left;" class="time">${item.updateDate?default("")}</span>
							</div>
						</li>
					</ul>
  ...
  <div class="s-index-side">
	  ...
	  <div class="buttons">
          ...
          <div class="buttons buttons2">
                <a href="${BasePath}/lanterngame/checkForward.kq?type=2" class="btn_ex btn-danger btn-danger2 btn-block">开始游戏</a>
            </div>   
	...
	$(".point").show();
	 $("#sharebj").css("display","block");
	  var form = document.getElementById("myform");
    	form.action="${BasePath}/jackgame/addCanPlayCount.kq";
			form.submit();
	}
