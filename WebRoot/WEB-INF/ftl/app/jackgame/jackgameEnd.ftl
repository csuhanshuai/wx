...
text-decoration: "";
	...
	.bg{
		...
		top:0;
		left:0;
		background: #000 url(../images/bg_240.png) top center no-repeat !important;
		...
		<ul class="weekly-list cls">
			<li>
				<div class="app-show-title">
					<h2><a style="font-size:20px;text-decoration:underline;" href="http://ijfer.chinasoftosg.com/ijferm/pages/qrCodePrd.html" >注册“解放号”可获取更多约章</a></h2>
				</div>
			</li>
		</ul>
...
<div class="paixu">
 ...
 <!--结束-->           
            ...
            <div class="buttons">
                <a href="${BasePath}/jackgame/showTopFive.kq" class="btn_ex btn-success btn-block" >查看排行榜</a>
               
            </div>
            <br>
             <a href="${BasePath}/lanterngame/checkForward.kq?type=2" class="kk" >继续游戏</a>
             </div>       
    </div>
</div>
