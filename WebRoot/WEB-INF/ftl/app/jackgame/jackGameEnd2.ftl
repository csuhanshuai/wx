...
<div class="container">
    ...
    <div class="text-center header">
		...
		<div class="paixu">
        	...
        	<li>
        	<span class="showdata">分数</span>
        	<span class="showdata">时间</span>
        </div>
        //返回当前的分数
        <#if jackGameScore??>
		      <#list jackGameScore as item>
        ...
        <div class="avatar1 text-center">
            <div class="img-circle" id="sicon"><span class="glyphicon glyphicon-thumbs-down"></span></div>
        </div>
    </div>
    <div id="bd" class="panel">
		...
		<div id="panel3" class="panel-body js_result" data-id="1">
            ...
            <div class="buttons">
                <a href="${BasePath}/lanterngame/showSort.kq" class="btn_ex btn-success btn-block" >查看排行榜</a>
            </div>
