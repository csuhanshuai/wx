    ...
    <div class="iframe_content">
        <div class="r_nav">
		    <ul>
				...
				<li class="cur"><a href="${BasePath}/zj/getConsumptionForward.kq">消费管理</a></li>
...
<div id="url" class="r_con_wrap">
    ...
    <table id="memberinfo" border="0" cellpadding="5" cellspacing="0" class="r_con_table" style="display:none">
            <tr>
                <td colspan="4" style="padding:15px 0;background-color: #c4dff8;">会员卡号：<span nowrap="" id="memberid"></span></td>
            ...
            <tr>
                ...
                <td  nowrap="nowrap">上次消费时间：</td>
                <td><div id="comsumptionintime"></div></td>
            </tr>
            <tr>
                <td nowrap="nowrap">余额：</td>
                <td colspan="3"><div id="balance" style="text-align: left;padding-left:10%"></div></td>
            </tr>
            <tr>
                <td nowrap="nowrap" colspan="4" style="padding:15px 10px 15px 0; text-align:right;">积分：<span id="integral" style="color:#ff0000; font-weight:bold;">20</span>分&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:getConsumptionByMemberid('<#if salesman??>${salesman}<#else>1</#if>');" >消费明细</a></td>
            </tr>
...
<script>
	...
	function checkFloatNum(num)
	{
	 ...
	 function inpay(){
	 	...
	 	var couponrecordid = document.getElementById("couponrecordid");
    	...
    	$.ajax({
	    		    url: BasePath+"/zj/addConsumption.kq?money=" + money.value + "&memberid=" + memberid.value + "&couponrecordid=" + couponrecordid.value,
	    		    type: "POST",
	    		    date: "",
	    		    datetype: "json",
	    		    async: false,
	    		    ...
	    		    success: function(result){
	    		    	...
	    		    	{
	    		    		var values = response.t.split("_");
	    		    		
	    		    		var comsumptionintime = document.getElementById("comsumptionintime");
	    		    		comsumptionintime.innerHTML=values[1];
	    		    		
	    		    		var integral = document.getElementById("integral");
	    		    		integral.innerHTML=values[0];
	    		    		
	    		    		var balance = document.getElementById("balance");
	    		    		balance.innerHTML=parseInt(balance.innerHTML) - parseInt(money.value);
