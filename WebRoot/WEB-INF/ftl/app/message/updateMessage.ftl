...
<div id="material" class="r_con_wrap">
            <form id="material_form" method="post" action="${BasePath}/updatePTMessage.kq?type=ptMessage">
                ...
                <input type="hidden" name="id" value="${wxmsg.id}"/>
                 <div class="m_lefter one">
                    ...
                    <div class="txt">${wxmsg.items[0].description?default('')}</div>
                </div>
                <div class="m_righter">
                    <div class="mod_form">
                        ...
                        <div class="m_form">
                            ...
                            <div class="input"><input name="Title" value="${wxmsg.items[0].title?default('')}" type="text" /></div>
                            ...
                            简短介绍<br />
                            <div><textarea name="BriefDescription">${wxmsg.items[0].description?default('')}</textarea></div>
                            <div class="blank20"></div>
