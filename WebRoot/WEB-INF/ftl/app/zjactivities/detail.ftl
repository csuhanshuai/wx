...
<#if activities??>
		...
		<tr>
			<td>
				<div>
	        	开始时间：${activities.starttime?default("")}
	    		</div>
			</td>
			<td>
				<div >
	        	结束时间：${activities.endtime?default("")}
	    		</div>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<div>
	        	活动描述：${activities.description?default("")}
	    		</div>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2">
				<div >
	        	活动图片：<img style="width:300px; *width:300px;" src="${BasePath}/${activities.photourl?default("")}">
	    		</div>
			</td>
		</tr>
<#else>
