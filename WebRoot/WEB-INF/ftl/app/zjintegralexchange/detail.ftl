...
<#if integralexchange??>
		<tr>
			<td>
				<div >
	        	积分兑换条目名称：${integralexchange.name?default("")}
	    		</div>
			</td>
			<td>
				<div >
	        	有效期：${integralexchange.validity?default("")}
	    		</div>
			</td>
		</tr>
		<tr>
			<td>
				<div >
	        	积分兑换分值：${integralexchange.score?default("")}
	    		</div>
			</td>
			<td>
				<div >
	        	录入时间：${integralexchange.intime?default("")}
	    		</div>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<div >
	        	兑换内容描述 ：${integralexchange.description?default("")}
	    		</div>
			</td>
		</tr>
<#else>
