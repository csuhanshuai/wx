...
.div-height{width:100%; height:120px ;display:inline-block;} 
</style>
...
<nav><img style="width:100%; height:30%;" class="banner" src="${BasePath}/images/banner5.jpg"/></nav>
<hr>
...
<#if VoteApply??>
	     <#if hasApprove??>
				 <div class="s-index-side">
						...
						<div class="skillbar clearfix " data-percent=${VoteApply.voteCount?default(0)}%>
							...
							<div class="skillbar-bar" style="background: #5a68a5;"></div>
							<div class="skill-bar-percent">票数:${VoteApply.voteCount?default(0)}</div>
						</div> 
				</div>
		<#else>
			<div class="s-index-side">
