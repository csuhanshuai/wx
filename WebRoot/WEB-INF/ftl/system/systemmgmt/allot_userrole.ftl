	            ...
	            <tbody>
	                ...
	                <tr>
		                <td valign="top">
							<a id="right_up" class="a-up">上移</a>
		               		<div class="sel-div">
		                		<select multiple id="select2" size="20">
		                			<#if notAllotList??>
		                ...
		                <td>
		                	...
		                	<div class="sel-div">
		               			<select  name="allowRoleValues" size="20" multiple id="select1" >
		                			<#if myRoleList??>
	                ...
	                <tr>
	                	<td colspan="3" align="center" height="80" valign="middle">
	                		...
	                		<input type="button" onclick="javascript:window.top.TB_remove();" class="yt-form-btn-back" value="取消" />
	                	</td>
	                </tr>
	            </tbody>
	        </table>
